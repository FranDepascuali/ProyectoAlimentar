...
extension Donation {
    ...
    static func fakedDonation(_ index: Double) -> Donation {
...
public struct FakedDonationsRepository: DonationRepositoryType {
    ...
    public func fetchDonations() -> SignalProducer<[Donation], NoError> {
        ...
        return SignalProducer(value: donations).delay(4, on: QueueScheduler())
    }
    ...
    public func fetchDonationsWithLocation() -> SignalProducer<[LocatedDonation], NoError> {
        ...
        return SignalProducer(value: fakedDonations).delay(4, on: QueueScheduler())
    }
}
